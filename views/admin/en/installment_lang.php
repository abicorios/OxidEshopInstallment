...
$aLang = [
    ...
    'ERROR_INSTALLMENT_PREPAYMENT_MUST_BE_POSITIVE' => 'Prepayment must be positive',
    'ERROR_INSTALLMENT_NUMBER_OF_MONTHS_MUST_BE_POSITIVE' => 'Number of installment months must be positive',
];
